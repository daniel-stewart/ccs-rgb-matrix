...
EYE_DATA = {
    'eye_image'        : EYE_PATH + 'adabot-eyes.png',
    'upper_lid_image'  : EYE_PATH + 'adabot-upper-lids.png',
    'lower_lid_image'  : EYE_PATH + 'adabot-lower-lids.png',
    'stencil_image'    : EYE_PATH + 'adabot-stencil.png',
